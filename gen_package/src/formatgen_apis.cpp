...
CQ_FORMAT_CALL bool CqFormat_MTLPixelFormatOnIOs(CqFormat_MTLPixelFormat fmt) {
	...
	VFile_Write(file, otherEnumsVk2, strlen(otherEnumsVk2));
	VFile_Write(file, otherEnumsD3D0, strlen(otherEnumsD3D0));
	VFile_Write(file, otherEnumsD3D1, strlen(otherEnumsD3D1));
	VFile_Write(file, otherEnumsD3D2, strlen(otherEnumsD3D2));
	VFile_Write(file, otherEnumsD3D3, strlen(otherEnumsD3D3));
