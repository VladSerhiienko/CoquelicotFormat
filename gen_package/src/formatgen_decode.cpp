...
static void GenCanDecodeLogicalPixelsF(VFile_Handle file) {
	...
	char const *const isPrefixF =
			"CQ_FORMAT_CALL bool CqFormat_CanDecodeLogicalPixelsF(CqFormat const fmt) {\n"
			"\tswitch(fmt) {\n";
...
static void GenCanDecodeLogicalPixelsD(VFile_Handle file) {
	...
	char const *const isPrefixF =
			"CQ_FORMAT_CALL bool CqFormat_CanDecodeLogicalPixelsD(CqFormat const fmt) {\n"
			"\tswitch(fmt) {\n";
...
void GenDecodeLogicalPixelsF(VFile_Handle file) {
	...
	char const *const isPrefixF =
			"CQ_FORMAT_CALL bool CqFormat_DecodeLogicalPixelsF(CqFormat const fmt, CqFormat_DecodeInput * in, uint32_t const width, float* out) {\n"
			"\tswitch(fmt) {\n";
...
void GenDecodeLogicalPixelsD(VFile_Handle file) {
	...
	char const *const isPrefixF =
			"CQ_FORMAT_CALL bool CqFormat_DecodeLogicalPixelsD(CqFormat const fmt, CqFormat_DecodeInput * in, uint32_t const width, double* out) {\n"
			"\tswitch(fmt) {\n";
...
static void GetSRGBTableFuncton(VFile_Handle file) {
	char const *const prefix =
			"CQ_FORMAT_CALL float CqFormat_LookupSRGB(uint8_t lookup) {\n"
			"\tswitch(lookup) {\n";
