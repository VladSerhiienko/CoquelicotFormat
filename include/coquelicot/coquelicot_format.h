...
CQ_FORMAT_CALL bool CqFormat_IsDepthOnly(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL bool CqFormat_IsStencilOnly(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL bool CqFormat_IsDepthAndStencil(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL bool CqFormat_IsCLUT(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL bool CqFormat_IsFloat(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL bool CqFormat_IsNormalised(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL bool CqFormat_IsSigned(CqFormat const fmt) {
	switch(fmt) {
		case CqFormat_R8_SNORM: return true;
...
CQ_FORMAT_CALL bool CqFormat_IsSRGB(CqFormat const fmt) {
	switch(fmt) {
		case CqFormat_R8_SRGB: return true;
		case CqFormat_R8G8_SRGB: return true;
		case CqFormat_R8G8B8_SRGB: return true;
...
CQ_FORMAT_CALL bool CqFormat_IsCompressed(CqFormat const fmt) {
	switch(fmt) {
		case CqFormat_DXBC1_RGB_UNORM: return true;
		case CqFormat_DXBC1_RGB_SRGB: return true;
		case CqFormat_DXBC1_RGBA_UNORM: return true;
...
CQ_FORMAT_CALL bool CqFormat_IsHomogenous(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL uint32_t CqFormat_WidthOfBlock(CqFormat const fmt) {
	switch(fmt) {
...
CQ_FORMAT_CALL uint32_t CqFormat_HeightOfBlock(CqFormat const fmt) {
	switch(fmt) {
		case CqFormat_UNDEFINED: return 0;
		case CqFormat_DXBC1_RGB_UNORM: return 4;
		case CqFormat_DXBC1_RGB_SRGB: return 4;
...
CQ_FORMAT_CALL uint32_t CqFormat_DepthOfBlock(CqFormat const fmt) {
	switch(fmt) {
		case CqFormat_UNDEFINED: return 0;
		default: return 1;
	}
...
CQ_FORMAT_CALL uint32_t CqFormat_BitSizeOfBlock(CqFormat const fmt) {
	switch(fmt) {
		case CqFormat_UNDEFINED: return 0;
		case CqFormat_R1_UNORM: return 8;
...
CQ_FORMAT_CALL uint32_t CqFormat_ChannelCount(CqFormat const fmt) {
	switch(fmt) {
		case CqFormat_UNDEFINED: return 0;
...
CQ_FORMAT_CALL uint32_t CqFormat_ChannelBitWidthAtPhysical(CqFormat const fmt, uint32_t const channel) {
...
CQ_FORMAT_CALL double CqFormat_MinAtPhysical(CqFormat const fmt, uint32_t const channel) {
	if(CqFormat_IsHomogenous(fmt) || channel == 0) {
		switch(fmt) {
...
CQ_FORMAT_CALL double CqFormat_MaxAtPhysical(CqFormat const fmt, uint32_t const channel) {
	if(CqFormat_IsHomogenous(fmt) || channel == 0) {
		switch(fmt) {
...
#if !defined(CQ_FORMAT_DECODE_H_)
#define CQ_FORMAT_DECODE_H_ 1
...
#if !defined(CQ_FORMAT_ENCODE_H_)
#define CQ_FORMAT_ENCODE_H_ 1
...
#endif // CQ_FORMAT_ENCODE_H_

#if !defined(CQ_FORMAT_APIS_H_)
#define CQ_FORMAT_APIS_H_ 1

#ifndef CQ_FORMAT_VKFORMAT
#define CQ_FORMAT_VKFORMAT
...
#ifndef CQ_FORMAT_DXGIFORMAT
#define CQ_FORMAT_DXGIFORMAT
...
#ifndef CQ_FORMAT_MTLPIXEL_FORMAT
#define CQ_FORMAT_MTLPIXEL_FORMAT
